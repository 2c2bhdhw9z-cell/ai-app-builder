...
- [x] 1. Static-asset delivery: additive server route + HTML shell + client bootstrap
  - [x] 1.1 Add the additive static-asset serving route to the Builder_Server
  ...
  - [x] 1.2 Author the CSP-clean HTML shell and stylesheet
  ...
  - [x] 1.3 Create the client bootstrap entry module
